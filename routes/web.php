 ...
 *
 * MEJORA: se usa Route::resource() parcial para evitar declarar
 * cada ruta a mano y seguir la convención REST de Laravel.
 *
...
Route::middleware('auth')->group(function () {
     ...
     *
     * MEJORA: se usa Route::resource() parcial para reducir repetición.
     * Equivale exactamente a las cuatro rutas originales (index, edit,
     * update, destroy) sin exponer create/store/show que no se usan aquí.
     *
     *  Método   URI                       Acción    Nombre de ruta
